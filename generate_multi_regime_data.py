#!/usr/bin/env python
"""
Multi-Regime Test Data Generator

This script generates synthetic price data that exhibits different market regimes:
- Trending (bull and bear)
- Mean-reverting
- Volatile
- Neutral/Random

This is useful for testing regime detection and adaptive strategies.
"""
import os
import argparse
import logging
...
def main():
    """Generate multi-regime test data."""
    # Parse arguments
    parser = argparse.ArgumentParser(description="Generate multi-regime test data")
