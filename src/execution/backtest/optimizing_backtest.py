...
class OptimizingBacktest(Component):
    ...
    def _run_backtest_with_params(self, strategy_name, params, data_split, train_test_config):
        ...
        # Modified approach for strategy creation
        # Create strategy with required dependencies first, then set parameters
        try:
            # First create with minimum requirements
            ...
            # Then set parameters individually
            ...
            try:
                ...
                for key, value in params.items():
                    try:
                        ...
                        logger.warning(f"Could not set parameter {key}={value} on strategy")
        ...
        # Wrap the strategy in an adapter if needed
        strategy_adapter = StrategyAdapter('strategy_adapter', strategy)
