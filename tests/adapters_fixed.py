"""
Central adapter module that imports all fixed adapters needed for tests.
"""

# Import all adapter modules
try:
    # Core module adapters
    from tests.unit.core.test_event_types_adapter_fixed import extend_event, ensure_event_extension
    ...
    from tests.integration.integration_adapters import extend_simulated_broker_integration, extend_event_bus_integration
    ...
    def apply_all_adapters():
        ...
        print("All adapters applied successfully using FIXED versions!")
