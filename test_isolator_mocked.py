#!/usr/bin/env python
"""
Test isolator script that uses mock Event class.
"""
...
def patch_sys_modules_for_mocks():
    """
    Patch sys.modules to use mocks for problematic modules.
    This ensures that when tests import event_types, they get our mocks instead.
    """
    from tests.mocks.event_mocks import MockEvent, MockEventType
    ...
    # Replace the real module in sys.modules if it exists
    ...
    print("Patched sys.modules to use mock Event classes")
