#!/usr/bin/env python3
"""
Run script for MA Crossover Strategy Optimization.
After applying all the fixes to the event system.
"""
import os
import sys
import logging
...
def main():
    ...
    logger.info("Starting MA Crossover optimization with fixed event system...")
